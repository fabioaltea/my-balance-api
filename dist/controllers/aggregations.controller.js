    ...
    static getMonthlyAggregations(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const aggregations = yield google_1.GoogleAuthHelper.executeWithRetry(userEmail, deviceType, (client) => __awaiter(this, void 0, void 0, function* () { return aggregations_helper_1.AggregationsHelper.getMonthlyAggregations(client, spreadsheetId, from_date, to_date); }));
