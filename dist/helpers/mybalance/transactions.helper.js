...
class TransactionsHelper {
    ...
    static normalizeType(type, amount) {
        ...
        if (raw === 'in' || raw === 'entrata' || raw === 'income' || raw === 'deposit')
            return 'in';
        if (raw === 'out' || raw === 'expense' || raw === 'uscita' || raw === 'withdraw')
            return 'out';
    ...
    static listTransactions(authClient, spreadsheetId, filters) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static parseDateForFilter(dateStr) {
        if (!dateStr)
            return null;
    ...
    static updateMovement(authClientClient, spreadsheetId, movementRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requestedTransactionIds = new Set((movementRequest.transactions || []).map((t) => t.transactionId).filter(Boolean));
     ...
     */
    static listTransactionsDelta(authClient, spreadsheetId, since) {
        return __awaiter(this, void 0, void 0, function* () {
            const rows = yield google_1.GoogleHelper.get(authClient, spreadsheetId, SHEET_RANGE);
            if (!rows || rows.length === 0)
                return [];
     ...
     */
    static parseMetaDateToDate(dateStr) {
        if (!dateStr)
            return null;
