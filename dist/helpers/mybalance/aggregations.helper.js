...
exports.AggregationsHelper = void 0;
...
class AggregationsHelper {
     ...
     */
    static getMonthlyAggregations(authClient, spreadsheetId, from_date, to_date) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const transactions = yield transactions_helper_1.TransactionsHelper.listTransactions(authClient, spreadsheetId, filters);
            // Aggregate by month
            const aggregations = {};
     ...
     */
    static extractYearMonth(dateStr) {
        if (!dateStr)
            return null;
...
exports.AggregationsHelper = AggregationsHelper;
//# sourceMappingURL=aggregations.helper.js.map