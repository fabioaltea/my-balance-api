    ...
    static createAccount(spreadsheetId, refreshToken, accountData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const currentRows = yield GoogleHelper_1.GoogleHelper.get(auth, spreadsheetId, SHEET_RANGE);
                ...
                const result = yield GoogleHelper_1.GoogleHelper.append(auth, spreadsheetId, SHEET_RANGE, body);
    ...
    static updateAccount(spreadsheetId, refreshToken, accountId, updateData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield GoogleHelper_1.GoogleHelper.update(auth, spreadsheetId, updateBody);
    ...
    static createAccountsBatch(spreadsheetId, refreshToken, accounts) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield GoogleHelper_1.GoogleHelper.append(auth, spreadsheetId, SHEET_RANGE, body);
...
//# sourceMappingURL=AccountsHelper.js.map